          ...
          <div className="how-cont">
            <div className="how-t-cont">
              <div className="info">
                <h3>كيف نلعبها</h3>
                <p>
                  كل اللي عليكم تقسمون أنفسكم الى فريقين, كل
                  <br /> فريق يختار 3 فئات و عندكم 3 وسائل <br /> مساعدة, لكل فريق 60 ثانية يجاوب, و
                  10 <br />
            ...
            <div className="how-w-cont">
              <h4>
                ...
                />
                  إذا تبون تجربة أفضل استخدموا شاشة كبيرة  مثل
              </h4>
            </div>
          </div>
        </div>
